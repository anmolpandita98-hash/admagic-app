      ...
      <div className="flex items-center justify-center p-12 lg:p-24 relative overflow-hidden">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-6">
            <button 
              onClick={handleLogin}
              className="w-full py-4 px-6 flex items-center justify-center gap-3 bg-white text-gray-900 font-bold text-base rounded-2xl hover:bg-gray-100 active:scale-95 transition-all duration-200 shadow-2xl border-0 group"
            >
